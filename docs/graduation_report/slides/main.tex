...
\begin{frame}{YOLO vs K-Means: Segmentation Comparison}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{segmentation_comparison.png}
...
\begin{frame}{YOLO Segmentation: Detailed Results}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{kmeans_vs_yolo_comparison.png}
...
\begin{frame}{Threshold: Top Strategies}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{threshold_top_bar.png}
...
\begin{frame}{Threshold: Score Distribution}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{threshold_top_strategies_new.png}
...
\begin{frame}{Threshold: Confusion Matrix}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{threshold_confusion_full.png}
...
\begin{frame}{Retrieval Pipeline Overview}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{query_flow.png}
...
\begin{frame}{Retrieval Performance: Heatmaps}
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth,height=0.60\textheight,keepaspectratio]{cv_heatmap_weighted_k_vs_media.png}
    \hfill
    \includegraphics[width=0.49\textwidth,height=0.60\textheight,keepaspectratio]{cv_heatmap_uni_k_vs_media.png}
...
\begin{frame}{Cross-Validation: Confusion Matrix}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{confusion_matrix_cv_best.png}
...
\begin{frame}{Best Single-Run Confusion Matrix}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{confusion_matrix_finetuned_best.png}
...
\begin{frame}{Cross-Validation: Aggregation Heatmaps}
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth,height=0.55\textheight,keepaspectratio]{cv_heatmap_agg_vs_k.png}
    \hfill
    \includegraphics[width=0.49\textwidth,height=0.55\textheight,keepaspectratio]{cv_heatmap_media_vs_agg.png}
...
\begin{frame}{Cross-Validation: Accuracy vs K \& Best Configs}
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth,height=0.60\textheight,keepaspectratio]{cv_accuracy_vs_k_fullprepared.png}
    \hfill
    \includegraphics[width=0.49\textwidth,height=0.60\textheight,keepaspectratio]{cv_best_configs_new.png}
...
\begin{frame}{Retrieval: Feature Extractor Comparison}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{extractor_comparison.png}
...
\begin{frame}{Retrieval: Top Configurations}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{retrieval_top_configs.png}
...
\begin{frame}{Retrieval: Staircase Progress}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{staircase_retrieval.png}
