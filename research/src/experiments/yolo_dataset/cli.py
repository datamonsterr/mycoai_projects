"""CLI wrapper for yolo_dataset experiment."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="yolo_dataset experiment CLI")
    ...
    try:
        from src.experiments.yolo_dataset.run import ExperimentParams, run as _run
