"""CLI wrapper for kmeans_segmentation experiment."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="kmeans_segmentation experiment CLI")
    ...
    try:
        from src.experiments.kmeans_segmentation.run import ExperimentParams, run_experiment as _run
