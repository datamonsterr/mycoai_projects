"""CLI wrapper for yolo_cross_validation experiment."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="yolo_cross_validation experiment CLI")
    ...
    try:
        from src.experiments.yolo_cross_validation.run import ExperimentParams, run as _run
