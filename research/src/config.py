...
FULL_PREPARED_DATASET_DIR = DATASET_ROOT / "full_prepared"
ORIGINAL_PREPARED_DATASET_DIR = DATASET_ROOT / "original_prepared"
NEW_DATA_PREPARED_DATASET_DIR = DATASET_ROOT / "new_data_prepared"
