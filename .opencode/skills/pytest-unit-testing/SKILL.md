...
description: Write focused pytest unit and API tests for Python code in the MycoAI monorepo, especially `backend/`.
version: 1.0.0
author: project
---
...
- Use `uv --directory backend run pytest`
- Keep tests under `backend/tests/`
