...
export default tool({
  ...
  async execute(args, context) {
    ...
    return [
      ...
      "4. if backend/.env.example exists: copy to .env",
      "5. if frontend/.env.example exists: copy to .env",
      "6. uv --directory backend sync --all-groups",
      "7. pnpm --dir frontend install",
      "8. mise trust",
