...
export default tool({
  ...
  async execute(args, context) {
    ...
    return [
      ...
      "4. if mycoai_retrieval_backend/.env.example exists: copy to .env",
      "5. if mycoai_retrieval_frontend/.env.example exists: copy to .env",
      "6. uv --directory mycoai_retrieval_backend sync --all-groups",
      "7. pnpm --dir mycoai_retrieval_frontend install",
      "8. mise trust",
