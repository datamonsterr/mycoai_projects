...
1. Read Markdown sources from `docs/graduation_report/content/`.
2. Convert each `.md` file to a corresponding `.tex` chapter file under `docs/graduation_report/latex/Chapter/`.
...
1. List all `.md` files in `docs/graduation_report/content/`.
...
3. Write each output to `docs/graduation_report/latex/Chapter/<name>.tex`.
