...
metadata:
  ...
  source: whatif:commands/analyze.md
---
...
Run `../.specify/scripts/bash/check-prerequisites.sh --json --include-tasks` once from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS.
...
- **constitution**: Project principles (from `.specify/memory/constitution.md`).
