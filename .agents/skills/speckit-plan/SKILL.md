...
metadata:
  ...
  source: multi-repo-branching:commands/speckit.plan.md
---
...
agent_scripts:
  sh: .specify/scripts/bash/update-agent-context.sh codex
  ps: .specify/scripts/powershell/update-agent-context.ps1 -AgentType codex
---
