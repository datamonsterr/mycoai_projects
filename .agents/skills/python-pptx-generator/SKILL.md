...
- Convert existing `.pptx` files to markdown with MarkItDown before analysis
- Use `@office-productivity` when the requested output should be a document or
  spreadsheet instead of a slide deck
