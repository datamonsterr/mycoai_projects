...
- Presentations: `@frontend-slides` or `@python-pptx-generator`
...
### Document creation
- Office docs: `@office-productivity`
- Note: for reading existing `.docx`, `.pdf`, `.xlsx`, or `.pptx` files,
  convert them to markdown with MarkItDown first
